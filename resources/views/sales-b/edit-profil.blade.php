...
<div class="content ">
    ...
    <div class="row">
        ...
        @php $data = Auth::user()->sales_b(Auth::user()->ID_USER); @endphp
            <form action="{{ url('/sales-b/edit-profil') }}" method="post" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" data-input-mask="phone" min="0" class="form-control num-without-style @error('NO_TELP') is-invalid @enderror" name="NO_TELP" value="{{ $data->NO_TELP_SALES_B }}">
                    <div class="invalid-feedback">
