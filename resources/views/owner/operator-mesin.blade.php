                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-stack datatable-component">
                            ...
                            <tbody>
                                @foreach($data as $d)
                                <tr>
                                    <td>{{$d->ID_OPERATOR_MESIN}}</td>
                                    <td>{{$d->NAMA_OPERATOR_MESIN}}</td>
                                    <td colspan="2">
                                        <button class="btn btn-sm btn-linkedin" data-toggle="modal" data-target="#modal-detail-pegawai-{{$d->ID_OPERATOR_MESIN}}">
...
<div class="modal fade" id="modal-detail-pegawai-{{$d->ID_OPERATOR_MESIN}}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="card-body card-body-profile">
                            <table class="profil-table">
                                ...
                                <tr>
                                    ...
                                    <td>{{$d->NO_TELP_OPERATOR_MESIN}}</td>
                                </tr>
                                <tr>
                                    <td class="label-detail">Email</td>
                                    <td>{{$d->EMAIL_OPERATOR_MESIN}}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
