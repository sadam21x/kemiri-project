...
<div class="content ">
    ...
    <div class="row">
        <div class="col-md-5 col-sm-12 form-tambah-sales-col">
            ...
            <form action="{{ url('/manajer-marketing/edit-profil') }}" method="post" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" min="0" data-input-mask="phone" class="form-control num-without-style @error('NO_TELP') is-invalid @enderror" name="NO_TELP" value="{{ $data->NO_TELP_MANAJER_MARKETING }}">
                    <div class="invalid-feedback">
