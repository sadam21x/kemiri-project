...
<div class="content ">
    ...
    <div class="row">
        <div class="col-md-5 col-sm-12 form-tambah-sales-col">
            ...
            <form action="{{ url('/admin-gudang/edit-profil') }}" method="post" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" data-input-mask="phone" min="0" class="form-control num-without-style @error('NO_TELP') is-invalid @enderror" name="NO_TELP" value="{{ $data->NO_TELP_ADMIN_GUDANG }}">
                    <div class="invalid-feedback">
