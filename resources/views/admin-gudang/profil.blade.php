    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <a href="{{ url('/admin-gudang/edit-profil') }}" data-toggle="tooltip" data-placement="bottom" title="Edit">
                        ...
                        <div class="card-body card-body-profile">
                            <table class="profil-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($data->JENIS_KELAMIN_ADMIN_GUDANG == 1)
                                        Pria
                                        @else
                                        Wanita
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->ALAMAT_ADMIN_GUDANG}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->NO_TELP_ADMIN_GUDANG}}</td>
                                </tr>
                                <tr>
                                    <td class="label-detail">Email</td>
                                    <td>{{$data->EMAIL_ADMIN_GUDANG}}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
