...
class DepoAirMinumTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=0;$i<10;$i++){
	        ...
	        // add owner
	        DB::table('depo_air_minum')->insert([
	            'KODE_KOTA' => $this->generate_id_kota(),
	            'ID_SALES_A' => rand(1,4),
	            'NAMA_CUSTOMER' => $name,
	            'NAMA_DEPO' => $faker->company,
	            'ALAMAT_DEPO' => $faker->streetAddress,
	            'NO_TELP_DEPO' => $faker->phoneNumber,
	            'EMAIL_DEPO' => $faker->email
	        ]);
        }
    }
